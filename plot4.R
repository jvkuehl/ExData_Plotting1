...
par(mfrow=c(2,2))
with(powersub, plot(datetime,Global_active_power,ylab="Global Active Power", xlab ="", type = "l"))
...
with(powersub, plot(datetime, Global_reactive_power, type="l", ylim=c(0,.5)))
dev.off()